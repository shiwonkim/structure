...
# Sequential FreezeAlign runs: FreezeAlign and FreezeAlign+STRUCTURE.
set -euo pipefail
...
CONFIGS=(
    "01_freeze_align         configs/freezealign/vits_minilm/fa_d512.yaml"
    "02_freeze_align_struct  configs/freezealign/vits_minilm/fa_d512_struct.yaml"
)
