...
DATASETS=("voc2012" "pascal_context" "ade20k")
DATA_ROOTS=("data/pascal_voc" "data/pascal_context" "data/ade20k/ADEChallengeData2016")
MAX_IMAGES=("" "2000" "2000")

# Baseline: anchor_codebook (already have results, but run again for consistency)
# Iterative CAP: 2, 3, 5 iterations
# Tau sharpening: 0.05, 0.03, 0.01, 0.005
